...
public class DarkNepenthes : Enemy
{
    ...
    private void Hit()
    {
        Instantiate(_projectilePrefab, transform.position + new Vector3(movement.direction * 0.1f, 0.2f, 0.0f), Quaternion.identity)
            .SetUp(gameObject, new Vector2(movement.direction * _projectileSpeed, 0.0f), _projectileDamage, _targetMask);
    }
}
