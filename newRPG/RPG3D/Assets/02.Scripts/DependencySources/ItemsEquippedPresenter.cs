    ...
    public class ItemsEquippedPresenter
    {
        ...
        public class UnequipCommand
        {
            ...
            public void Execute(ItemEquippedSlot slot)
            {
                ...
                /* presenter의 dependency source를 수정한 코드 , 이거말고 원본 데이터를 수정해야함
                //_presenter.inventoryEquipmentSource.equipmentSlotDatum[inventoryEmptySlotIndex] = new InventoryData.EquipmentSlotData()
                //{
                //    itemID = itemEquippedSlotData.itemID,
                //    enhanceLevel = itemEquippedSlotData.enhanceLevel,
                //    itemNum = 1
                ...
                //_presenter.itemsEquippedSource.itemsEquippedSlotDatum[(int)slot.bodyPart] = new ItemsEquippedData.ItemEquippedSlotData()
                //{
                //    part = equippedItemData.bodyPart,
                //    itemID = 0,
                //    enhanceLevel = 0
